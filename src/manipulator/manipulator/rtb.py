...
class KinematicSolver(Node):
    ...
    def __init__(self,x=None,y=None,z=None):
        ...
        topic_name = "/manipulator_arm_controller/joint_trajectory"
        self.trajectory_publisher = self.create_publisher(JointTrajectory, topic_name, 10)
        self.timer = self.create_timer(1, self.timer_callback)
        self.joints = ['manipulator_joint1','manipulator_joint2','manipulator_joint3',
                       'manipulator_joint4','manipulator_joint5','manipulator_joint6',
                       'manipulator_joint7','manipulator_finger_joint1']
